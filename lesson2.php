...
<br> <br>
  <div class="card-body"  style="margin-left: 20px;">
    <h5 class="card-title" style='font-size:25px;' ><b>Lesson 2 Topics</b></h5>
	<br><br>
    <a href="#Introduction"  style='font-size:22px;'>Introduction</a><br>
    <a href="The 4 chambers of heart" style='font-size:20px;' >Layers</a><br>
	<a href="Layers" style='font-size:22px;' ></a><br>
    <a href="Size" style='font-size:22px;' ></a><br>
	<a href="Location" style='font-size:22px;' ></a><br>
  </div>
</div> 
...
<p class="font-14 ml-0" align="center" style='font-size:20px;'>
									<b>Lesson 2 </b>
 <br>                                   
<br>
<div class="col-lg-12 col-md-13 col-sm-12">
                                    ...
                                    <section id="Introduction"> 
										<h4 class="mb-20 pt-20"><b>Introduction</b></h4>
...
This animation shows the functioning of this extraordinarily complex pump in action. As you read this article, try scrolling back up and seeing if you can spot the chambers, valves, and blood vessels we’re discussing in action:
										...
										<p>
                                        <img src="img/heart.jpg" style="width:600px;height:500px;"   class="card-img-top" alt="...">
										</p>
                                        <br>
                                    ...
                                    <section id="Function of the heart"> 
                                    <h4 class="mb-20 pt-20"><b>Function of the Heart </b></h4>
                                    </p>
                                    ...
                                    The heart pumps blood through our immense and complicated circulatory systems at high pressure. It is a truly impressive feat of engineering, as it must circulate about five liters of blood through a full 1,000 miles worth of blood vessels each minute! We will talk more about how the heart accomplishes this remarkable task under the “Heart Structure” section below.
                                        ...
                                        <br><br><br>
                                        <section id="Heart Structures"> 
                                        <h4 class="mb-20 pt-20"><b>Heart Structure </b></h4>
                                    </p>
                                    ...
                                    <br>
                                    <p align="center">
                                        <img src="img/Structure-of-the-human-heart.webp" style="width:600px;height:500px;"   class="card-img-top" alt="...">

                                        <section id="Layers of the Heart Wall"> 
                                        <h4 class="mb-20 pt-20"><b>Layers of the Heart Wall </b></h4>
										</p>
                                        <p  style='font-size:20px;'>
                                        <b>The Epicardium.</b> The epicardium is also sometimes considered a part of the protective pericardial membrane around the heart. It helps to keep the heart lubricated and protected.
                                        </p>
                                        <p  style='font-size:20px;'>
                                       <b> The Myocardium. </b>The myocardium is the muscle of the heart. You can remember this because the root word “myo” comes from “muscle,” while “cardium” comes from “heart.”
                                        ...
                                        <p  style='font-size:20px;'>
                                        <b>The Endocardium. </b> The endocardium is a thin, protective layer on the inside of the heart. It is made of smooth, slippery endothelial cells, which prevent blood from sticking to the inside of the heart and forming deadly blood clots.
                                        </p>
                                        <br><br><br>

                                       
                                        <section id="Chambers of the Heart"> 
                                        <h4 class="mb-20 pt-20"><b>Chambers of the Heart</b></h4>
										</p>
                                    ...
                                    <br>
                                        <p  style='font-size:20px;'>
                                        <b>The Right Atrium.</b>The right and left atria are the smaller chambers of the heart, and they have thinner, less muscular walls. This is because they only receive blood from the veins – they don’t have to pump it back out through the whole circulatory system!
                                        ...
                                        <p  style='font-size:20px;'>
                                       <b> The Right Ventricle.</b>The ventricles are larger chambers with stronger, thicker walls. They are responsible for pumping blood to the organs at high pressures.
                                    ...
                                    The right ventricle is the one attacked to the pulmonary circuit. It pumps blood through the pulmonary artery and to the lungs, where the blood fills with oxygen, at high pressure. The blood then returns to…
                                        ...
                                        <p  style='font-size:20px;'>
                                        <b>The left atrium </b>receives oxygenated blood from the pulmonary veins. It pumps this blood into the left ventricle, which…
                                        </p>
                                        <p  style='font-size:20px;'>
                                        <b>The left ventricle  </b> pumps blood throughout the rest of the body.
                                        </p>
                                        <br>
                                        ...
                                        <br>
                                        <p  style='font-size:20px;'>
                                        In most people, this whole circulatory path only takes about a minute to complete! </p>
                                        <br><br><br>

                                        <section id="Valves of the Heart"> 
                                        <h4 class="mb-20 pt-20"><b>Valves of the Heart</b></h4>
										</p>      
                                    ...
                                    Heart valves are just that – biological valves that only allow blood to flow through the heart in one direction, ensuring that all the blood gets to where it needs to be.
                                        ...
                                        <br>
                                        <p  style='font-size:20px;'>
                                        <b>The Tricuspid Valve.</b>The tricuspid valve is what is called an “atrioventricular” valve. As you might guess by the name, it ensures that blood only flows from the atrium to the ventricle – not the other way around.
                                        ...
                                        <b>The pulmonary valve</b> is what is called a semilunar valve. Semilunar valves are found in arteries leaving the heart. Their role is to prevent blood from flowing backwards from the arteries into the heart’s chambers.
                                        ...
                                        The pulmonary valve lies in between the pulmonary artery and the left ventricle, where it ensures that blood pumped into the pulmonary artery continues to the lungs instead of returning to the heart.</b>The pulmonary valve is what is called a semilunar valve. Semilunar valves are found in arteries leaving the heart. Their role is to prevent blood from flowing backwards from the arteries into the heart’s chambers.
                                        This is important because the ventricles “suck” blood in from the atria by expanding after they have expelled blood into the arteries. Without properly functioning semilunar valves, blood can flow back into the ventricle instead of going to the rest of the body. This drastically decreases the efficiency with which the heart can move oxygenated blood through the body.
                                        ...
                                        <b>The Mitral Valve. </b> The mitral valve is the other atrioventricular valve. This one lies between the left atrium and the left ventricle. It prevents blood from flowing back from the ventricle into the atrium, ensuring that that blood is pumped to the rest of the body instead!
                                         mitral valve lies at the opening of the aorta, which is the largest blood vessel in the body. The aorta is the central artery from which all other arteries fill. It is thicker than a garden hose, extends all the way from our hearts down to our pelvis, where it splits in two to become the femoral artery of each leg.
                                        </p>
                                        <br>

                                        <p  style='font-size:20px;'>
                                    <b>The Aortic Valve.     . </b>As you might have guessed, the aorta needs a semilunar valve just like the pulmonary artery does. The aortic valve prevents blood from flowing backwards from the aorta into the left ventricle as the left ventricle “sucks” in oxygenated blood from the left atrium.
                                            <p>        
                                        <br>
                                        <p  style='font-size:20px;'>
                                        ...
                                        <br><br><br>
                                        <section id="The Sinoatrial Node"> 
                                        <h4 class="mb-20 pt-20"><b>The Sinoatrial Node</b></h4>
										</p> 
                                        <br>
                                        <p  style='font-size:20px;'>

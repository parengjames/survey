...
(1, 'How many chambers does the heart have?', '4', '5', '1', '2', '4', '[value-8]', 1),
(2, 'It receives oxygen-poor blood from the body and pumps it to the right ventricle.', 'Left ventricle', 'Right ventricle', 'Right atrium', 'Left atrium', 'Right atrium', '[value-8]', 1),
(3, 'It pumps the oxygen-rich blood to the body.', 'Left  ventricle', 'Right ventricle', 'Right atrium', 'Left atrium', 'Left  ventricle', '[value-8]', 1),
(4, 'It pumps the oxygen-poor blood to the lungs.', 'Left  ventricle', 'Right ventricle', 'Right atrium', 'Left atrium', '	Right ventricle', '[value-8]', 1),
(5, 'It receives oxygen-rich blood from the lungs and pumps it to the left ventricle.', 'Left  ventricle', 'Right ventricle', 'Right atrium', 'Left atrium', 'Left atrium', '[value-8]', 1),
(6, 'What is the plural for atrium?', 'Atriums', 'Atria', 'Atrias', 'Atrium', 'Atria', '[value-8]', 1),
(7, 'The _____  serves as the primary pumping chambers of the heart, propelling blood to the lungs or to the rest of the body.', 'Atrium', 'Ventricle', 'Atria', 'Capillaries', 'Ventricle', '[value-8]', 1),
(8, 'It transports blood to and from the lungs, where it picks up oxygen and delivers carbon dioxide for exhalation.', '	Systemic circuit', 'Pulmonary circuit', 'Pulmonary capillaries', 'Systemic capillaries', 'Pulmonary circuit', '[value-8]', 1),
(9, 'It transports oxygenated blood to virtually all of the tissues of the body and returns to the heart.', 'Systemic circuit', 'Pulmonary circuit', 'Pulmonary capillaries', 'Systemic capillaries', 'Systemic circuit', '[value-8]', 1),
(10, 'The right ventricle pumps deoxygenated blood into the  ______.', 'Pulmonary trunk', 'Pulmonary arteries', 'Pulmonary capillaries', 'Pulmonary veins', 'Pulmonary trunk', '[value-8]', 1),
(11, 'What are the 4 chambers of the heart?', 'Right atrium, left atrium, right ventricle ,  left ventricle', 'Pulmonary trunk, Pulmonary arteries , pulmonary capillaries, pulmonary veins', 'Systemic atrium, pulmonary atrium,  systemic ventricle, pulmonary ventricle', 'Right chamber, left chamber, down chamber , up chamber', 'Right atrium, left atrium, right ventricle ,  left ventricle', '[value-8]', 1),
(12, 'The wall of the heart is composed of three layers of 	unequal thickness. These are:', 'Epicardium, myocardium, endocardium', 'Capillaries, atrium , veins , chamber', 'Systemic atrium, pulmonary atrium,  systemic ventricle, pulmonary ventricle', 'Right chamber, left chamber, down chamber , up chamber', 'Epicardium, myocardium, endocardium', '[value-8]', 1),
(13, 'The middle and thickest layer is the _______, made largely of cardiac muscle cells.', 'Epicardium', 'Myocardium', 'Pericardium', 'Endocardium ', 'Myocardium', '[value-8]', 1),
(14, 'It is the _________  of the myocardium that pumps blood through the heart and into the major arteries.', 'Contraction ', 'Palpitation', 'Distraction', 'Reaction', 'Contraction ', '[value-8]', 1),
(15, 'How many layers does the heart have?', '3', '2', '5', '1', '3', '[value-8]', 1);
...
(6, 6, 1, 1, 5, 1, 1, '2023-01-08 07:01:03');
...
--
ALTER TABLE `quiz_attempt`
  MODIFY `quizAttempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `quiz_mistake`
  MODIFY `mistake_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2023 at 08:32 AM
...
--
ALTER TABLE `quiz_attempt`
  MODIFY `quizAttempt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT for table `quiz_correct`
--
ALTER TABLE `quiz_correct`
  MODIFY `quizCorrect_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `quiz_mistake`
  MODIFY `mistake_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
